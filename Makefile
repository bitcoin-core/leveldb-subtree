...
SHARED_MEMLIB = libmemenv.$(PLATFORM_SHARED_EXT)
else
...
SHARED_MEMLIB1 = libmemenv.$(PLATFORM_SHARED_EXT)
SHARED_MEMLIB2 = $(SHARED_MEMLIB1).$(SHARED_VERSION_MAJOR)
SHARED_MEMLIB3 = $(SHARED_MEMLIB1).$(SHARED_VERSION_MAJOR).$(SHARED_VERSION_MINOR)
SHARED_MEMLIBS = $(SHARED_OUTDIR)/$(SHARED_MEMLIB1) $(SHARED_OUTDIR)/$(SHARED_MEMLIB2) $(SHARED_OUTDIR)/$(SHARED_MEMLIB3)
$(SHARED_OUTDIR)/$(SHARED_MEMLIB1): $(SHARED_OUTDIR)/$(SHARED_MEMLIB3)
	ln -fs $(SHARED_MEMLIB3) $(SHARED_OUTDIR)/$(SHARED_MEMLIB1)
$(SHARED_OUTDIR)/$(SHARED_MEMLIB2): $(SHARED_OUTDIR)/$(SHARED_MEMLIB3)
	ln -fs $(SHARED_MEMLIB3) $(SHARED_OUTDIR)/$(SHARED_MEMLIB2)
endif

$(SHARED_OUTDIR)/$(SHARED_LIB3): $(SHARED_LIBOBJECTS)
	$(CXX) $(LDFLAGS) $(PLATFORM_SHARED_LDFLAGS)$(SHARED_LIB2) $(SHARED_LIBOBJECTS) -o $(SHARED_OUTDIR)/$(SHARED_LIB3) $(LIBS)

$(SHARED_OUTDIR)/$(SHARED_MEMLIB3): $(SHARED_MEMENVOBJECTS) $(SHARED_OUTDIR)/$(SHARED_LIB3)
	$(CXX) $(LDFLAGS) $(PLATFORM_SHARED_LDFLAGS)$(SHARED_MEMLIB2) $(SHARED_MEMENVOBJECTS) -o $(SHARED_OUTDIR)/$(SHARED_MEMLIB3) $(LIBS) $(SHARED_OUTDIR)/$(SHARED_LIB3)

endif  # PLATFORM_SHARED_EXT

all: $(SHARED_LIBS) $(SHARED_MEMLIBS) $(SHARED_PROGRAMS) $(STATIC_OUTDIR)/libleveldb.a $(STATIC_OUTDIR)/libmemenv.a $(STATIC_PROGRAMS)
